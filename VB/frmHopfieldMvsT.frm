...
Begin VB.Form frmHopfieldMvsT 
   ...
   Begin VB.Frame frmHopfieldMvsTemp 
      ...
      Begin MSChart20Lib.MSChart MSChart1 
         Height          =   4515
         Left            =   135
         OleObjectBlob   =   "frmHopfieldMvsT.frx":014A
         TabIndex        =   32
         Top             =   225
         Width           =   6720
      End
...
Private Const c_strDefaultOut As String = "D:\ANN_VB\defaultData\m_t_Hopfield_out.txt"
Private Const c_strFileNameIn As String = "D:\ANN_VB\data\m_t_Hopfield_in.txt"
Private Const c_strFileNameOut As String = "D:\ANN_VB\data\m_t_Hopfield_out.txt"
...
Private Sub pvtLoadParam(strPath As String)
    ...
    Line Input #intFileNr, strLine
    txtTemp.Text = Right(strLine, Len(strLine) - Len(c_strTemp) - 1)
    sclTemp.Value = Val(txtTemp.Text) * 100
    Line Input #intFileNr, strLine
...
Private Sub cmdPlot_Click()
    ...
    pvtSave (False)
    returnValue = m_t_Hopfield(c_strFileNameIn, c_strFileNameOut)
...
Private Sub pvtSave(blnWithDialogue As Boolean)
    ...
    Print #intFileNr, "temp "; txtTemp.Text
...
Private Sub sclTemp_Change()
    txtTemp.Text = sclTemp.Value / 100
End Sub
...
Private Sub txtTemp_LostFocus()
    If Val(txtTemp.Text) < 0 Then txtTemp.Text = 0
    If Val(txtTemp.Text) > 1 Then txtTemp.Text = 1
    sclTemp.Value = Val(txtTemp.Text) * 100
End Sub
