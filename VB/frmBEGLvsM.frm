...
Begin VB.Form frmBEGLvsM 
   Caption         =   "     BEG: l vs m"
   ClientHeight    =   4935
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   13500
   Icon            =   "frmBEGLvsM.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   4935
   ScaleWidth      =   13500
   Begin VB.Frame frmHopfieldMvsTemp 
      ...
      Begin MSChart20Lib.MSChart MSChart1 
         Height          =   4605
         Left            =   90
         OleObjectBlob   =   "frmBEGLvsM.frx":014A
         TabIndex        =   8
         Top             =   180
         Width           =   6720
      End
...
Private Declare Function l_m_BEG _
...
Private Const c_strDefaultOut As String = "D:\ANN_VB\defaultData\l_m_BEG_out.txt"
Private Const c_strFileNameIn As String = "D:\ANN_VB\data\l_m_BEG_in.txt"
Private Const c_strFileNameOut As String = "D:\ANN_VB\data\l_m_BEG_out.txt"
...
Private Sub cmdPlot_Click()
    ...
    pvtSave (False)
    returnValue = l_m_BEG(c_strFileNameIn, c_strFileNameOut)
